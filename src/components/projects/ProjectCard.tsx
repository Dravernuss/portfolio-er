...
const ProjectCard = ({project}: ProjectCardProps) => {
  return (
    <div className="w-95 md:w-1/3 lg:w-1/4">
      <div className="bg-white/5 rounded-xl shadow-lg overflow-hidden border border-purple-300 hover:border-indigo-500 transition-transform transform hover:scale-105">
        <img
          src={project.imgPath}
          alt="project"
